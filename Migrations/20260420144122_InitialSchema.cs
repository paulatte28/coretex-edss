...
namespace coretex_finalproj.Migrations
{
    ...
    public partial class InitialSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "BranchSubmissions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BranchId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SubmissionYear = table.Column<int>(type: "int", nullable: false),
                    SubmissionMonth = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BranchSubmissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BranchSubmissions_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoalTargets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GoalTargets_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MinProfitMargin = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    MaxExpenseRatio = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    MinMonthlyProfit = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    RiskAlertLevel = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_KpiThresholds_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportTypes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BranchId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_BranchId_CreatedAt",
                table: "ActivityLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BranchSubmissions_BranchId_SubmissionYear_SubmissionMonth",
                table: "BranchSubmissions",
                columns: new[] { "BranchId", "SubmissionYear", "SubmissionMonth" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KpiThresholds_BranchId_IsActive",
                table: "KpiThresholds",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportSchedules_BranchId_IsEnabled",
                table: "ReportSchedules",
                columns: new[] { "BranchId", "IsEnabled" });
